            ...
            <div class="content-panel">
                ...
                <div class="container">
                            ...
                            <div class="table-content-two height">
                                <table>
                                    <tbody cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <a href="/pages/addres.php">Шевченка</a>
                                            </td>
                                            <td>
                                                <div class="button-table">
                                                    <a class="table-link" href="edit-area.php"><i class="fas fa-cogs"></i></a>
                    ...
                    <footer class="footer">
                        ...
                        <a class="button button-position" href="/pages/add-areas.php">Добавить район</a>
                        </div>
                    </footer>
                </div>
            </div>
